...
qplot(x = factor(smoke), y = weight, data = babies, geom = "boxplot") +
  facet_grid(parity ~ .)
qplot(x = factor(parity), y = weight, data = babies, geom = "boxplot") +
  facet_grid(smoke ~ .)
...
inference(x = offshore$college_grad, y = offshore$response, 
          est = "proportion", success = "no opinion",
          alternative = "twosided", type = "ht", 
