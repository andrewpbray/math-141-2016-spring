...
*You should have run `binom.test` here with something like `binom.test(X, n)` for their values of `X` and `n`.  You also should have extracted the confidence interval correctly from the output.*
