...
$$ T = \frac{{X}\text{-bar}_{smoking} - {X}{\text{-bar}}_{nonsmoking}}{{SE}_{\bar{X}_{smoking} - \bar{X}_{nonsmoking}}} $$

*where ${SE}_{\bar{X}_{smoking} - \bar{X}_{nonsmoking}} = \sqrt{\dfrac{s_{smoking}^2}{n_{smoking}} + \dfrac{s_{nonsmoking}^2}{n_{nonsmoking}}}$.*
...
```{r oyo3, eval = TRUE}
inference(y = nc$gained, x = nc$mature, est = "mean", type = "ht", alternative = "twosided", null = 0,
          method = "theoretical")
```
